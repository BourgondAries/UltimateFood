function runGUI()
    ...
    (...
        ...
        ...%'Position', [760/1000 42.5/500 110/1000 32.5/500],...
        'Position', [760/1000 10/500 110/1000 65/500],...
        'Callback', @compute...
    );

    %{
    filter_button = uicontrol...
    (...
        'Parent', window,...
        'Units', 'normalized',...
        'Style', 'pushbutton', 'String', 'Remove zeros',...
        'Position', [760/1000 10/500 110/1000 32.5/500],...
        'Callback', @removeZerosFromResult...
    );
    %}
    ...
    (...
        ...
        'Position', [90/1000 42.5/500 90/1000 32.5/500],...
    ...
    (...
        ...
        'Position', [180/1000 42.5/500 100/1000 32.5/500],...
        'Callback', @deleteFoodEntry...
    );

    select_all_button = uicontrol...
    (...
        'Parent', window,...
        'Units', 'normalized',...
        'Style', 'pushbutton', 'String', 'Select All',...
        'Position', [90/1000 10/500 90/1000 32.5/500],...
        'Callback', @selectAll...
    );
    ...
    (...
        'Parent', window,...
        'Units', 'normalized',...
        'Style', 'pushbutton', 'String', 'Deselect All',...
        'Position', [180/1000 10/500 100/1000 32.5/500],...
    ...
    function selectAll(source, callbackdata)
        food_stuffs_table.Data(:, 2) = {true};
    end

    function deselectAll(source, callbackdata)
        food_stuffs_table.Data(:, 2) = {false};
    end
    %{
    function removeZerosFromResult(source, callbackdata)
        [sorted, overwrites] = sortrows(result.Data(:, 1));
        result.Data = result.Data(overwrites, :);
    end
    %}
    window.Visible = 'on';
end
